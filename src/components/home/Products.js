...
import { addToCart } from "../../redux/MarketSlice";
        ...
        >
          ...
          <div className="px-4 bg-white flex flex-col gap-1 z-10">
            ...
            <button
              ...
              className="w-full py-1.5 rounded-md mt-3 font-titleFont font-medium text-base bg-gradient-to-tr from-[#1058ffd3] to-[#1059FF] border border-black hover:from-[#2121fae8] to hover:to-[#2121fab9] active:bg-gradient-to-bl active:from-[#2121faac] active:to-[#2121faa5] duration-200"
            >
              Add to Cart
            </button>
          </div>

      ...
      {products.length > 0 ? (
        <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
          ...
          <div className="col-span-5 md:col-span-3 lg:col-span-2 xl:col-span-1 bg-white h-52 flex items-center p-4">
            <div>
              ...
              <button className="w-full font-titleFont font-medium text-base bg-gradient-to-tr from-[#1058ffd3] to-[#1059FF] border hover:from-[#2121fae8] hover:to-[#2121fab9] border-black active:bg-gradient-to-bl active:from-[#2121faac] active:to-[#2121faa5] duration-200 py-1.5 rounded-md mt-3">
                Proceed to Buy
              </button>
            </div>
          </div>
        ...
        >
          ...
          <div className="w-96 p-4 bg-white flex  flex-col items-center rounded-md shadow-lg">
            ...
            <Link to="/">
              <button className="mt-6 bg-[#1058ffd3] rounded-md cursor-pointer hover:bg-[#2121fab9] active:bg-[#2121faa5] px-8 py-2 font-titleFont font-semibold text-lg">
                Continue Shopping 
              </button>
            </Link>
          </div>

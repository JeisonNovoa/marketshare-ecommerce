...
export const middleList = [
    ...
    listItem: [
      {
        ...
        listData: [
          ...
          "About MartketShare",
          "Investor Relations",
          "MartketShare Devices",
          "MartketShare Science",
        ],
      },
    ],
  },
    ...
    listItem: [
      {
        _id: "002",
        listData: [
          "Sell products on MartketShare",
          "Sell on MartketShare Business",
          "Sell apps on MartketShare",
          "Become an Affiliate",
          "Advertise Your Products",
          "Sell Product with Us",
          "Host an MartketShare Hub",
  ...
  {
    _id: 2223,
    title: "MartketShare Payment Products",
    listItem: [
      {
        _id: "003",
        listData: [
          "MartketShare Business Card",
          "Shop with Points",
          "Reload Your Balance",
          "MartketShare Currency Converter",
        ],
      },
    ],
  },
    ...
    listItem: [
      {
        _id: "004",
        listData: [
          "MartketShare and COVID-19",
          "Your Account",
          "Your Orders",
          "Shipping Rates & Policies",
          "Returns & Replacements",
          "Manage Your Content and Devices",
          "MartketShare Assistant",
          "FAQ & Help",
        ],
      },
    ],
...
export const footerBottomItem = [
  {
    _id: 1001,
    title: "	MartketShare Advertising",
    des: "Find, attract, and engage customers",
  },
  {
    _id: 1002,
    title: "MartketShare Drive",
    des: "Cloud storage from MartketShare",
  },
  {
    _id: 1003,
    title: "6pm",
  ...
  {
    _id: 1006,
    title: "Sell on MartketShare",
    des: "Start a Selling Account",
  },
  {
    _id: 1007,
    title: "MartketShare Business",
    des: "Everything For Your Business",
  },
  {
    _id: 1008,
    title: "MartketShareGlobal",
  ...
  {
    _id: 1010,
    title: "MartketShare Ignite",
    des: "Sell your original Digital Educational Resources",
  },
  {
    _id: 1011,
    title: "MartketShare Web Services",
  ...
  {
    _id: 1029,
    title: "MartketShare Subscription Boxes",
